...
const MASTERCARD = 'https://upload.wikimedia.org/wikipedia/commons/0/04/Mastercard-logo.png';
const VISA = 'https://resources.mynewsdesk.com/image/upload/ojf8ed4taaxccncp6pcp.png';
...
class SetCard extends React.Component {
    ...
    isNext = () => {
        ...
        if (this.state.cvc.length != 3)
            return false;
        if (this.state.cvc.validDate === '')
            return false;
        if (this.state.cvc.owner === '')
            return false;
        return true;
    }

    render = () => {
        return <KeyboardAwareScrollView contentContainerStyle={{flex: 1}} behavior='position'>
            <Touchable
            ...
            style={{
                ...
                style={{
                    ...
                    <View style={{
                        width: 9,
                        height: 9,
                        backgroundColor: this.state.agreement ? 'rgb(225, 199, 155)' : 'transparent'
                    }}>
            ...
            <Text style={{
                ...
                color: '#fff'
            }}>{'Привяжите банковскую карту'}</Text>
            <LinearGradient
                colors={[
                    "rgba(87, 88, 98, 1)",
                    "rgba(65, 66, 77, 1)"
            ...
            >
                <View style={{ flex: 2 }}/>
                <View style={{ flex: 2, flexDirection: 'column', marginBottom: 12, marginHorizontal: 20 }} >
                    <TextInputMask
                    ...
                    <View style={{
                        ...
                        <View style={{ flexDirection: 'column', justifyContent: 'flex-end', marginLeft: 25 }}>
                        <Image 
                            resizeMode='contain'
                            source={{
            ...
            <TextField
                ...
                onChangeText={(code) => {this.setState({ cvc: code }) }}
                style={{
                    alignItems: 'center',
                    textAlign: 'center',
                    width: 160
