    ...
    >
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={{width: viewportWidth}}>
          ...
          <Text style={{ fontSize: 10, color: '#dcc49c', textAlign: 'center', marginTop: 5, marginBottom: 2, fontFamily: 'open-sans' }}>{'Тип кухни'}</Text>
          <View style={{
            width: viewportWidth - 40,
            marginBottom: 20,
            padding: 6,
            ...
            <TouchableOpacity onPress={() => this._drawer.open()} style={{ flexDirection: 'row' }}>
              ...
              <Icon name='ios-arrow-down' color='#ffffff' style={{top: 3}} size={18}/>
            </TouchableOpacity>
          </View>
